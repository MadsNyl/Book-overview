...
exports.getAllWishlistBooks = async (req, res) => {
    ...
    try {
        const books = await pool.query('SELECT * FROM wishlist LIMIT 5 OFFSET $1', [page])
...
exports.createWishlistBook = async (req, res) => {
    try {
        ...
        const book = await pool.query('INSERT INTO wishlist (title, author, link, price) VALUES ($1, $2, $3, $4)', [title, author, link, price])
